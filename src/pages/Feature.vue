<template>
  ...
  >
    ...
    >
      <div
        class="absolute inset-0 -mr-3.5 bg-gradient-to-r from-red-800 to-yellow-300 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:rotate-3 sm:rounded-3xl"
      ></div>
            ...
            <div class="flex space-x-6">
              ...
              >
                <a class="flex" :href="botUrl" target="_blank">
                  ...
                  <span>{{ $t("setup.add") }}</span>
                </a>
              </button>
              
              <router-link
                :to="{ path: 'feature' }"
                class=" flex mt-6 px-8 py-4 rounded-full font-normal tracking-wide bg-gradient-to-b from-red-600 to-red-700 text-white outline-none focus:outline-none hover:shadow-lg hover:from-red-900 transition duration-200 ease-in-out"
              >
               <svg
                    class="w-5 h-5 mr-2"
                    fill="currentColor"
